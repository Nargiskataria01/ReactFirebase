        ...
        <div>
          ...
          backgroundColor: 'black', color: 'sandybrown', borderColor: "black"
            ...
            <div className='cards' style={{ marginTop: '4%', display: 'flex', marginLeft: '25%', }}>
                ...
                <Card style={{ marginLeft: '3%', backgroundColor: 'sandybrown' }}  >
                ...
                <Card style={{ marginLeft: '5%', backgroundColor: 'sandybrown' }}  >
                    <CardContent   >
                        ...
                        <Typography color="textSecondary" gutterBottom style={{ display: "flex", color: 'black', }}>
                            {renderStatusDot("Yellow")}  <span style={{ marginLeft: "4px" }}> Busy </span>
                        </Typography>
                ...
                <Card style={{ marginLeft: '5%', backgroundColor: 'sandybrown' }}  >
                    ...
                    <CardContent>
                        ...
                        <Typography color="textSecondary" gutterBottom style={{ color: 'black', display: "flex" }}>
                            {renderStatusDot("Red")}   <span style={{ marginLeft: "4px" }}> Away </span>
                        </Typography>
            ...
            <div className='cardss' style={{ width: '55%', marginTop: '30px', marginLeft: '20%' }}>
                <Card >
                        ...
                        time?.map((i, x) => {
                            return (
                                <CardContent style={{ display: 'flex', backgroundColor: "black" }}>
                                    ...
                                    <Grid item xs={4}>
                                        <Typography color="textSecondary" gutterBottom style={{ marginLeft: '38%', display: "flex", color: 'sandybrown' }}>
                    ...
                    <CardContent style={{ backgroundColor: "black", display: "flex" }}>
                        ...
                        <Grid item xs={4}>
                            <Typography color="textSecondary" gutterBottom style={{ color: "sandybrown", marginLeft: "50%" }}>
                                Total Hours
                            </Typography>
                        </Grid>
